...
export const GET: APIRoute = async ({ request, locals, url }) => {
  ...
  if (!isCustomerAccountConfigured(env)) return Response.redirect(hostedCustomerAccountUrl, 302);
  ...
  try {
    ...
    return Response.redirect(hostedCustomerAccountUrl, 302);
  }
};
